...
package STM32_SVD.RNG is
   ...
   type CR_Register is record
      --  unspecified
      Reserved_0_1  : STM32_HAL.UInt2 := 16#0#;
      --  Random number generator enable
      RNGEN         : Boolean := False;
      --  Interrupt enable
      IE            : Boolean := False;
      --  unspecified
      Reserved_4_31 : STM32_HAL.UInt28 := 16#0#;
   end record
   ...
   type SR_Register is record
      ...
      SECS          : Boolean := False;
      --  unspecified
      Reserved_3_4  : STM32_HAL.UInt2 := 16#0#;
      --  Clock error interrupt status
      CEIS          : Boolean := False;
      --  Seed error interrupt status
      SEIS          : Boolean := False;
      --  unspecified
      Reserved_7_31 : STM32_HAL.UInt25 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
