...
package STM32_SVD.RCC is
   ...
   subtype CR_HSITRIM_Field is STM32_HAL.UInt5;
   subtype CR_HSICAL_Field is STM32_HAL.UInt8;
   ...
   type CR_Register is record
      ...
      HSIRDY         : Boolean := True;
      --  unspecified
      Reserved_2_2   : STM32_HAL.Bit := 16#0#;
      ...
      CSSON          : Boolean := False;
      --  unspecified
      Reserved_20_23 : STM32_HAL.UInt4 := 16#0#;
      --  Main PLL (PLL) enable
      PLLON          : Boolean := False;
      ...
      --  unspecified
      Reserved_28_31 : STM32_HAL.UInt4 := 16#0#;
   end record
   ...
   subtype PLLCFGR_PLLM_Field is STM32_HAL.UInt6;
   subtype PLLCFGR_PLLN_Field is STM32_HAL.UInt9;
   subtype PLLCFGR_PLLP_Field is STM32_HAL.UInt2;
   subtype PLLCFGR_PLLQ_Field is STM32_HAL.UInt4;
   ...
   subtype CFGR_SW_Field is STM32_HAL.UInt2;
   subtype CFGR_SWS_Field is STM32_HAL.UInt2;
   subtype CFGR_HPRE_Field is STM32_HAL.UInt4;
   --  CFGR_PPRE array element
   subtype CFGR_PPRE_Element is STM32_HAL.UInt3;
   ...
   subtype CFGR_RTCPRE_Field is STM32_HAL.UInt5;
   subtype CFGR_MCO1_Field is STM32_HAL.UInt2;
   subtype CFGR_MCO1PRE_Field is STM32_HAL.UInt3;
   subtype CFGR_MCO2PRE_Field is STM32_HAL.UInt3;
   subtype CFGR_MCO2_Field is STM32_HAL.UInt2;
   ...
   type CFGR_Register is record
      ...
      --  unspecified
      Reserved_8_9 : STM32_HAL.UInt2 := 16#0#;
   ...
   type CIR_Register is record
      ...
      CSSC           : Boolean := False;
      --  unspecified
      Reserved_24_31 : STM32_HAL.UInt8 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_11_11 : STM32_HAL.Bit := 16#0#;
      --  CRC reset
      CRCRST         : Boolean := False;
      --  unspecified
      Reserved_13_20 : STM32_HAL.UInt8 := 16#0#;
      --  DMA2 reset
      ...
      --  unspecified
      Reserved_24_24 : STM32_HAL.Bit := 16#0#;
      --  Ethernet MAC reset
      ETHMACRST      : Boolean := False;
      --  unspecified
      Reserved_26_28 : STM32_HAL.UInt3 := 16#0#;
      --  USB OTG HS module reset
      OTGHSRST       : Boolean := False;
      --  unspecified
      Reserved_30_31 : STM32_HAL.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB2RSTR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : STM32_HAL.UInt5 := 16#0#;
      --  Random number generator module reset
      RNGRST        : Boolean := False;
      --  USB OTG FS module reset
      OTGFSRST      : Boolean := False;
      --  unspecified
      Reserved_8_31 : STM32_HAL.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB3RSTR_Register is record
      ...
      --  unspecified
      Reserved_1_31 : STM32_HAL.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type APB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_9_10  : STM32_HAL.UInt2 := 16#0#;
      --  Window watchdog reset
      WWDGRST        : Boolean := False;
      --  unspecified
      Reserved_12_13 : STM32_HAL.UInt2 := 16#0#;
      --  SPI 2 reset
      SPI2RST        : Boolean := False;
      --  SPI 3 reset
      SPI3RST        : Boolean := False;
      --  unspecified
      Reserved_16_16 : STM32_HAL.Bit := 16#0#;
      --  USART 2 reset
      ...
      --  unspecified
      Reserved_27_27 : STM32_HAL.Bit := 16#0#;
   ...
   type APB2RSTR_Register is record
      ...
      --  unspecified
      Reserved_2_3   : STM32_HAL.UInt2 := 16#0#;
      --  USART1 reset
      USART1RST      : Boolean := False;
      --  USART6 reset
      USART6RST      : Boolean := False;
      --  unspecified
      Reserved_6_7   : STM32_HAL.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_19_19 : STM32_HAL.Bit := 16#0#;
      --  SPI5 reset
      ...
      --  unspecified
      Reserved_23_25 : STM32_HAL.UInt3 := 16#0#;
      --  LTDC reset
      LTDCRST        : Boolean := False;
      --  unspecified
      Reserved_27_31 : STM32_HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB1ENR_Register is record
      ...
      CRCEN          : Boolean := False;
      --  unspecified
      Reserved_13_17 : STM32_HAL.UInt5 := 16#0#;
      ...
      --  unspecified
      Reserved_31_31 : STM32_HAL.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB1LPENR_Register is record
      ...
      --  unspecified
      Reserved_13_14 : STM32_HAL.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_20_20 : STM32_HAL.Bit := 16#0#;
   ...
   type AHB2LPENR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : STM32_HAL.UInt5 := 16#18#;
   ...
   type BDCR_Register is record
      ...
      --  unspecified
      Reserved_3_7   : STM32_HAL.UInt5 := 16#0#;
      --  RTC clock source selection
      RTCSEL         : BDCR_RTCSEL_Field := (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_10_14 : STM32_HAL.UInt5 := 16#0#;
      --  RTC clock enable
      RTCEN          : Boolean := False;
      --  Backup domain software reset
      BDRST          : Boolean := False;
      --  unspecified
      Reserved_17_31 : STM32_HAL.UInt15 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CSR_Register is record
      ...
      --  unspecified
      Reserved_2_23 : STM32_HAL.UInt22 := 16#0#;
      --  Remove reset flag
      RMVF          : Boolean := False;
      --  BOR reset flag
   ...
   subtype SSCGR_MODPER_Field is STM32_HAL.UInt13;
   subtype SSCGR_INCSTEP_Field is STM32_HAL.UInt15;
   ...
   type SSCGR_Register is record
      ...
      --  unspecified
      Reserved_28_29 : STM32_HAL.UInt2 := 16#0#;
      --  Spread Select
   ...
   subtype PLLI2SCFGR_PLLI2SN_Field is STM32_HAL.UInt9;
   subtype PLLI2SCFGR_PLLI2SQ_Field is STM32_HAL.UInt4;
   subtype PLLI2SCFGR_PLLI2SR_Field is STM32_HAL.UInt3;

   --  PLLI2S configuration register
   type PLLI2SCFGR_Register is record
      --  unspecified
      Reserved_0_5   : STM32_HAL.UInt6 := 16#0#;
      --  PLLI2S multiplication factor for VCO
      PLLI2SN        : PLLI2SCFGR_PLLI2SN_Field := 16#C0#;
      --  unspecified
      Reserved_15_23 : STM32_HAL.UInt9 := 16#0#;
   ...
   subtype PLLSAICFGR_PLLSAIN_Field is STM32_HAL.UInt9;
   subtype PLLSAICFGR_PLLSAIQ_Field is STM32_HAL.UInt4;
   subtype PLLSAICFGR_PLLSAIR_Field is STM32_HAL.UInt3;
   ...
   subtype DCKCFGR_PLLI2SDIVQ_Field is STM32_HAL.UInt5;
   subtype DCKCFGR_PLLSAIDIVQ_Field is STM32_HAL.UInt5;
   subtype DCKCFGR_PLLSAIDIVR_Field is STM32_HAL.UInt2;
   subtype DCKCFGR_SAI1ASRC_Field is STM32_HAL.UInt2;
   subtype DCKCFGR_SAI1BSRC_Field is STM32_HAL.UInt2;
   ...
   type DCKCFGR_Register is record
      ...
      --  unspecified
      Reserved_5_7   : STM32_HAL.UInt3 := 16#0#;
      --  PLLSAIDIVQ
      PLLSAIDIVQ     : DCKCFGR_PLLSAIDIVQ_Field := 16#0#;
      --  unspecified
      Reserved_13_15 : STM32_HAL.UInt3 := 16#0#;
      --  PLLSAIDIVR
      PLLSAIDIVR     : DCKCFGR_PLLSAIDIVR_Field := 16#0#;
      --  unspecified
      Reserved_18_19 : STM32_HAL.UInt2 := 16#0#;
      --  SAI1ASRC
      ...
      --  unspecified
      Reserved_25_31 : STM32_HAL.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
